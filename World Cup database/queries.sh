...
echo "$($PSQL "select distinct(name) from games full join teams on games.winner_id=teams.team_id or games.opponent_id = teams.team_id where games.year = 2014 and games.round='Eighth-Final'")"
