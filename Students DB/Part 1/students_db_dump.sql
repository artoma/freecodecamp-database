...
--
-- Name: students fk_student_major; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.students
    ADD CONSTRAINT fk_student_major FOREIGN KEY (major_id) REFERENCES public.majors(major_id);


--
-- Name: majors_courses fk_to_courses; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.majors_courses
    ADD CONSTRAINT fk_to_courses FOREIGN KEY (course_id) REFERENCES public.courses(course_id);


--
-- Name: majors_courses fk_to_majors; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.majors_courses
    ADD CONSTRAINT fk_to_majors FOREIGN KEY (major_id) REFERENCES public.majors(major_id);
